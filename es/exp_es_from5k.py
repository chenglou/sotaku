...
# bs2048_baseline_clean_a's checkpoint at step 5,000 (a tenth of the schedule, learning rate still near peak) — the same
...
CHECKPOINT_PREFIX = "es_from5k_checkpoint_step"

CONFIG = {
    'experiment': 'exp_es_from5k',
    'es_generations': 120,
    'population_pairs': 16,
    'sigma': 'calibrated',
    'lr': 3e-4,
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_es_from5k.pt")
