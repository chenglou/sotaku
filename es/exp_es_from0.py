...
# bs2048_baseline_clean_a's checkpoint at step 0 (weights essentially at initialization) — the same
...
CHECKPOINT_PREFIX = "es_from0_checkpoint_step"

CONFIG = {
    'experiment': 'exp_es_from0',
    'es_generations': 60,
    'population_pairs': 16,
    'sigma': 'calibrated',
    'lr': 3e-4,
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_es_from0.pt")
