...
#
# Rescue-law cohort: seed is step-40,000 checkpoint (84.4% at 128, 0.2% at 1024 — deliberately AT the 85% boundary; a boundary probe).
...
CHECKPOINT_PREFIX = "es_cohort_a_checkpoint_step"

CONFIG = {
    'experiment': 'exp_es_cohort_a',
    'es_generations': 60,
    'population_pairs': 16,
    'sigma': 'calibrated',
    'lr': 3e-4,
...
def train(output_dir="."):
    ...
    if start_gen >= total_steps:
        ...
        final_path = os.path.join(output_dir, "model_es_cohort_a.pt")
