...
#
# Rescue-law cohort: seed is the same cohort_d step-45,000 seed (93.9% at 128, 1.6% at 1024) whose sparse-fitness rescue sat flat at 24/1000 — dense cell fitness is the suspect fix for the sparse-signal stall.
...
CHECKPOINT_PREFIX = "es_cohort_d2_checkpoint_step"

CONFIG = {
    'experiment': 'exp_es_cohort_d2',
    'es_generations': 60,
    'population_pairs': 16,
    'sigma': 'calibrated',
    'lr': 3e-4,
...
def train(output_dir="."):
    ...
    if start_gen >= total_steps:
        ...
        final_path = os.path.join(output_dir, "model_es_cohort_d2.pt")
