...
#
# Rescue-law cohort run d: seed is the step-45,000 checkpoint (93.9% at 128, 1.6% at 1024 — the near-miss shape).
...
CHECKPOINT_PREFIX = "es_cohort_d_checkpoint_step"

CONFIG = {
    'experiment': 'exp_es_cohort_d',
    'es_generations': 60,
    'population_pairs': 16,
    'sigma': 'calibrated',
    'lr': 3e-4,
...
def train(output_dir="."):
    ...
    if start_gen >= total_steps:
        ...
        final_path = os.path.join(output_dir, "model_es_cohort_d.pt")
