...
# bs2048_baseline_clean_a's checkpoint at step 10,000 (a fifth of the schedule) — the same
...
CHECKPOINT_PREFIX = "es_from10k_checkpoint_step"

CONFIG = {
    'experiment': 'exp_es_from10k',
    'es_generations': 120,
    'population_pairs': 16,
    'sigma': 'calibrated',
    'lr': 3e-4,
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_es_from10k.pt")
