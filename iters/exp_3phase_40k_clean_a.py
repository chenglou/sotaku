# Clean-run robustness test a: exact exp_3phase_40k recipe (3-phase curriculum,
# stops at 40K steps before the deep anneal), fresh unseeded draw, uninterrupted.
# Tests whether this config still settles reliably in the July 2026 environment.
...
CHECKPOINT_PREFIX = "3phase_40k_clean_a_checkpoint_step"

CONFIG = {
    'experiment': 'exp_3phase_40k_clean_a',
    'd_model': 128,
    'd_ff': 512,
    'n_layers': 4,
    'batch_size': 2048,
...
log_name = "exp_3phase_40k_clean_a.log"
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_3phase_40k_clean_a.pt")
