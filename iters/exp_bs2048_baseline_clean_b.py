# Clean-run test b: exact exp_bs2048_baseline (LR=1.5e-3) recipe, fresh unseeded draw,
...
CHECKPOINT_PREFIX = "bs2048_baseline_clean_b_checkpoint_step"

CONFIG = {
    'experiment': 'exp_bs2048_baseline_clean_b',
    'd_model': 128,
    'd_ff': 512,
    'n_layers': 4,
    'batch_size': 2048,
...
log_name = "exp_bs2048_baseline_clean_b.log"
...
def train(output_dir="."):
    ...
    log("\n" + "="*60)
    log("FINAL RESULTS - exp_bs2048_baseline_clean_b")
    log("="*60)
    results = evaluate_all()
    total_r = results.pop('_total')
    ...
    final_path = os.path.join(output_dir, "model_bs2048_baseline_clean_b.pt")
