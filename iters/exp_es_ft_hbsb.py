...
#
# Seed: bs2048_baseline_clean_b_checkpoint_step35000.pt — 6.7% at 1024 iterations but
# 89.0% at 128, the same shape as the successfully rescued 5.4% model (short horizons
# intact, only the long-horizon drift broken). This run's final weights (1.2% at 1024,
# ~14% at 128) resisted ES entirely, so this seed tests whether the rescue boundary is
# short-horizon health rather than the 1024-iteration score itself.
...
CHECKPOINT_PREFIX = "es_ft_hbsb_checkpoint_step"

CONFIG = {
    'experiment': 'exp_es_ft_hbsb',
    'es_generations': 60,
    'population_pairs': 16,
    'sigma': 'calibrated',
    'lr': 3e-4,
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_es_ft_hbsb.pt")
