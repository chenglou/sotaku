# Clean-run robustness test c: exact exp_3phase_40k recipe (3-phase curriculum,
...
CHECKPOINT_PREFIX = "3phase_40k_clean_c_checkpoint_step"

CONFIG = {
    'experiment': 'exp_3phase_40k_clean_c',
    'd_model': 128,
    'd_ff': 512,
    'n_layers': 4,
    'batch_size': 2048,
...
log_name = "exp_3phase_40k_clean_c.log"
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_3phase_40k_clean_c.pt")
