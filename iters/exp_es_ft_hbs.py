...
#
# Seed: bs2048_baseline_clean_a_checkpoint_step40000.pt — the best mid-training
# checkpoint (92.8% at 1024 iterations) of a run that finished at 31.2%. Tests the
# harvest-plus-ES composition: recover a failed run from its best checkpoint rather
# than its final weights, which ES alone could not repair for deep collapses.
...
CHECKPOINT_PREFIX = "es_ft_hbs_checkpoint_step"

CONFIG = {
    'experiment': 'exp_es_ft_hbs',
    'es_generations': 60,
    'population_pairs': 16,
    'sigma': 'calibrated',
    'lr': 3e-4,
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_es_ft_hbs.pt")
