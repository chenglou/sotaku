...
CHECKPOINT_PREFIX = "testbed_fbnoise_b_checkpoint_step"

CONFIG = {
    'experiment': 'exp_testbed_fbnoise_b',
    'd_model': 128,
    'd_ff': 512,
    'n_layers': 4,
    'batch_size': 2048,
...
log_name = "exp_testbed_fbnoise_b.log"
...
def train(output_dir="."):
    ...
    log("\n" + "="*60)
    log("FINAL RESULTS - exp_testbed_fbnoise_b")
    log("="*60)
    results = evaluate_all()
    total_r = results.pop('_total')
    ...
    final_path = os.path.join(output_dir, "model_testbed_fbnoise_b.pt")
