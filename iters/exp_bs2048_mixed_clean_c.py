# Clean-run robustness test c: exact exp_bs2048_mixed recipe (mixed sampling, no
# curriculum, 50K steps), fresh unseeded draw, uninterrupted. Tests whether this
# config still settles reliably in the July 2026 environment.
...
CHECKPOINT_PREFIX = "bs2048_mixed_clean_c_checkpoint_step"

CONFIG = {
    'experiment': 'exp_bs2048_mixed_clean_c',
    'd_model': 128,
    'd_ff': 512,
    'n_layers': 4,
    'batch_size': 2048,
...
log_name = "exp_bs2048_mixed_clean_c.log"
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_bs2048_mixed_clean_c.pt")
