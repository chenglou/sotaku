# Clean-run robustness test b: exact exp_bs2048_mixed recipe (mixed sampling, no
...
CHECKPOINT_PREFIX = "bs2048_mixed_clean_b_checkpoint_step"

CONFIG = {
    'experiment': 'exp_bs2048_mixed_clean_b',
    'd_model': 128,
    'd_ff': 512,
    'n_layers': 4,
    'batch_size': 2048,
...
log_name = "exp_bs2048_mixed_clean_b.log"
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_bs2048_mixed_clean_b.pt")
