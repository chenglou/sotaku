...
CHECKPOINT_PREFIX = "testbed_fbnoise_d_checkpoint_step"

CONFIG = {
    'experiment': 'exp_testbed_fbnoise_d',
    'd_model': 128,
    'd_ff': 512,
    'n_layers': 4,
    'batch_size': 2048,
...
log_name = "exp_testbed_fbnoise_d.log"
...
def train(output_dir="."):
    ...
    log("\n" + "="*60)
    log("FINAL RESULTS - exp_testbed_fbnoise_d")
    log("="*60)
    results = evaluate_all()
    total_r = results.pop('_total')
    ...
    final_path = os.path.join(output_dir, "model_testbed_fbnoise_d.pt")
