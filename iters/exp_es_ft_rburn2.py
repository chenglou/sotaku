...
CHECKPOINT_PREFIX = "es_ft_rburn2_checkpoint_step"

CONFIG = {
    'experiment': 'exp_es_ft_rburn2',
    'es_generations': 60,
    'population_pairs': 16,
    'sigma': 'calibrated',
    'lr': 3e-4,
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_es_ft_rburn2.pt")
