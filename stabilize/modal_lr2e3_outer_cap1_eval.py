"""Evaluate the three harvested 50K cap-1 checkpoints on Modal.

Usage:
    modal run --detach stabilize/modal_lr2e3_outer_cap1_eval.py
"""
...
app = modal.App("sudoku-lr2e3-outer-cap1-eval")
...
def run_evaluation(output_prefix: str):
    ...
    from stabilize.eval_lr2e3_outer_cap1 import evaluate
...
def main(output_prefix: str = "lr2e3_outer_cap1_best_full_horizon"):
