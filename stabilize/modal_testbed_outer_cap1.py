"""Launch one outer-RMS-cap-1 20K testbed trial on Modal.

Usage:
    modal run --detach stabilize/modal_testbed_outer_cap1.py --trial 0
"""
...
def run_trial(run_name: str, random_seed: int):
    ...
    from stabilize.exp_testbed_outer_cap1 import train
...
def main(
    trial: int = 0,
    run_prefix: str = "testbed_outer_cap1",
):
    if trial < 0:
