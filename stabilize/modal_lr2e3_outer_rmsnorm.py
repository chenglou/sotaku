"""Launch one full-schedule recurrent-RMSNorm training trial on Modal.

Usage:
    modal run --detach stabilize/modal_lr2e3_outer_rmsnorm.py --trial 0
"""

import modal


app = modal.App("sudoku-lr2e3-outer-rmsnorm")
...
def run_trial(run_name: str, random_seed: int):
    ...
    from stabilize.exp_lr2e3_outer_rmsnorm import train
...
def main(trial: int = 0, run_prefix: str = "lr2e3_outer_rmsnorm"):
    if trial < 0:
