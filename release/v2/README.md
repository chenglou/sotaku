...
Public downloads, the example solve, and the archived evaluation counts were verified after publication. The [publication record](publication.json) records the release commit, asset checksums, and completed checks.
