...
from looping.hyperloop.common import protocol, run_config, run_name
...
def analyze(root, data_dir):
    ...
    from looping.hyperloop.common import validate_data
    ...
    return {"study_id": settings["study_id"], "runs": records,
            "versus_baseline": compare(profiles), "versus_one_stream": compare(profiles, "gated_one")}
...
def main():
    ...
    print(json.dumps({name: report[name] for name in ("versus_baseline", "versus_one_stream")}, indent=2))
