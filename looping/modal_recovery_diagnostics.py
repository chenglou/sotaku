"""Run recurrent recovery diagnostics on Modal."""
...
app = modal.App("sudoku-recovery-diagnostics")

PRESET_NAMES = (
    "reference_models",
    "extreme_timing_models",
    "delayed_switch_trajectory",
)
...
def run_diagnostics(
    ...
    from looping.eval_recovery_diagnostics import MODEL_PRESETS, evaluate
...
def main(
    output_prefix: str = "recovery_diagnostics_reference_n1000",
