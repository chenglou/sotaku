"""Run recurrent update-source decomposition on Modal."""

import modal


app = modal.App("sudoku-update-source-decomposition")
...
def run_diagnostics(
    ...
    from looping.eval_update_source_decomposition import evaluate
...
def main(
    output_prefix: str = "update_source_decomposition_n1000_v1",
